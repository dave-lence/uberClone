...
const RequestScreen = ({navigation}) => {
  return (
    <View style={styles.container}>
      <TouchableOpacity onPress={() => navigation.goBack()} activeOpacity={0.7} style={styles.view1}>
        <Icon
      ...
      <View style={styles.view2}>
        ...
        <View style={styles.view4}>
          <View>
            <Image
              style={styles.image1}
              source={require("../../assest/transit.png")}
            />
          </View>


          <View>
            <TouchableOpacity activeOpacity={0.5} onPress={() => navigation.navigate("Destination")}>
